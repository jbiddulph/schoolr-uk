                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="eventDate" class="form-control @error('eventDate') is-invalid @enderror">
                                            @error('eventDate')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="eventTimeStart" class="form-control @error('eventTimeStart') is-invalid @enderror">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="eventTimeEnd" class="form-control @error('eventTimeEnd') is-invalid @enderror">
                                            @error('eventTimeEnd')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
